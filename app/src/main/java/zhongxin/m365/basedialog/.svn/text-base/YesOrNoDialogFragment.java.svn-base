...
public class YesOrNoDialogFragment extends DialogFragment implements
	...
	public static YesOrNoDialogFragment newInstance(String title) {
		YesOrNoDialogFragment hdf = new YesOrNoDialogFragment();
		Bundle bundle = new Bundle();
		bundle.putString("help_resource", title);
		hdf.setArguments(bundle);
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
			Bundle icicle) {
		View v = inflater.inflate(R.layout.dialogyesorno, container, false);
